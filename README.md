...
* [ ] заново пересмотреть алгоритм генерации диалогов
* [ ] сделать фильтрацию диалогов по тегам
* [ ] добавить черный список для юзеров, сообщения которых не парсить
* [ ] добавить теги в диалоги в админку и фильтр

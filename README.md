...
* [ ] добавить в телеграмдиалог поля активности диалога
* [ ] добавить в дилаоги коллво сообщений
* [ ] пересмотреть Генерации сообщений он почему-то генерит в каждом диалоге пустое сообщение с юзером SMBD

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_status', models.PositiveSmallIntegerField(choices=[(1, 'Login Required'), (2, 'Login Done'), (3, 'Login Failed'), (4, 'Login Waiting For Telegram Client')], default=1, verbose_name='Login Required')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Session',
            fields=[
                ('client_session', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='djelethon.clientsession', verbose_name='Client Session')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='djelethon.clientsession', verbose_name='Client Session')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='djelethon.clientsession', verbose_name='Client Session')),
            ],
            options={
                'verbose_name': 'Entity',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('entity_id', 'client_session'), name='entity_id_client_session_unique'),
        ),

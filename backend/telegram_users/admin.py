...
from .models import TelegramUser, MemberUser, ListenerUser, ActorUser
...
@admin.register(ListenerUser)
class ListenerUserAdmin(admin.ModelAdmin):
    pass


@admin.register(ActorUser)
class ActorUserAdmin(admin.ModelAdmin):
    pass
